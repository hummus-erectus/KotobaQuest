...
const main = async () => {
  try {
    console.log("Seeding database for Unit 1, Lesson 2")
    ...
    await db.insert(schema.challengeOptions).values([
      ...
      },
      {
        ...
        correct: false,
        text: "drink",
        audioSrc: "/audio/en/en_drink.mp3",
      },
      ...
      // Question 9 - 寝る (sleep)
      {
        ...
        correct: true,
        text: "sleep",
        audioSrc: "/audio/en/en_sleep.mp3",
      },
      {
        challengeId: 19,
        imageSrc: "/walk.svg",
